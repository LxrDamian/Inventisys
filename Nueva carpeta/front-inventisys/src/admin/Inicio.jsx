      ...
      <div className="row mt-5">
        ...
        <div className="col-md-6 mb-4">
          <div className="card shadow h-100">
            <div className="card-body text-center">
              ...
              <p className="card-text">Gestiona o consulta los productos</p>
              <button
        ...
        {hasRole("ADMIN") && (
          <div className="col-md-6 mb-4">
            <div className="card shadow h-100">
              <div className="card-body text-center">
                <i className="bi bi-speedometer2 display-1 text-warning"></i>
        ...
        {hasRole("ADMIN") && (
          <div className="col-md-6 mb-4">
            <div className="card shadow h-100">
              <div className="card-body text-center">
                <i className="bi bi-receipt display-1 text-info"></i>
                <h3 className="card-title mt-3">Ventas</h3>
                <p className="card-text">Consulta todas las ventas</p>
                <button
